...
const HeroSection: React.FC = React.memo(() => (
  <section className="relative min-h-[80vh] flex items-center justify-center overflow-hidden">
    ...
    <div className="absolute inset-0 bg-[#1B3A2F]/70" />
    {/* Gradiente sutil encima del overlay */}
    <div className="absolute inset-0 bg-gradient-to-t from-[#1B3A2F]/60 via-transparent to-transparent" />
              ...
              <div className="bg-white rounded-xl p-6 shadow-sm h-full">
                ...
                <div className="flex items-center space-x-3">
                  ...
                  <div>
                    ...
                    <p className="text-xs text-[#1B3A2F]/50">{formatDate(review.date)}</p>
                  </div>
                </div>
              </div>
            </AnimatedSection>
