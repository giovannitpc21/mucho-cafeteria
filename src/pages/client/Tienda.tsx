...
const ProductCard: React.FC<{
  ...
  return (
    <div className="bg-white rounded-xl overflow-hidden shadow-sm hover:shadow-lg transition-all border border-[#E8DDD4] group">
      <div className="aspect-square bg-[#E8DDD4]/50 flex items-center justify-center relative">
        <div className="w-24 h-24 bg-[#1B3A2F]/10 rounded-full flex items-center justify-center">
          <Coffee className="w-12 h-12 text-[#1B3A2F]/40" />
        </div>
        {!product.inStock && (
